...
Section $(TEXT_ENTRY_TITLE) SectionEntry
  ...
  File "..\dist\Entry for JINI-win32-ia32\win-ia32-unpacked\locales\*.*"

  SetOutPath "$INSTDIR\resources"
  File /r "..\dist\Entry for JINI-win32-ia32\win-ia32-unpacked\resources\*.*"

  SetOutPath "$INSTDIR"
  File "..\dist\Entry for JINI-win32-ia32\win-ia32-unpacked\*.*"
  File "icon.ico"
